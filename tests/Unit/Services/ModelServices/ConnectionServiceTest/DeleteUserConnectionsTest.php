...
class DeleteUserConnectionsTest extends BaseTest
{
    ...
    public function testSuccess()
    {
        ...
        $response = $connectionServiceMock->deleteUserConnections([$connection->id], [$user->id]);
    ...
    {
        $connectionServiceMock = $this->getMockService(ConnectionService::class);
        $response = $connectionServiceMock->deleteUserConnections([1], []);
