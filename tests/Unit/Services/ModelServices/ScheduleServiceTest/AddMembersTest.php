...
class AddMembersTest extends BaseTest
{
    ...
    public function testSuccess()
    {
        ...
        $response = $scheduleServiceMock->addMembers($schedule->id, [$user->id], [$contact->id]);
    ...
    public function testPublished()
    {
        ...
        $response = $scheduleServiceMock->addMembers($schedule->id, [], []);
